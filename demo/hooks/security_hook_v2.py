#!/usr/bin/env python3
"""
Enhanced Claude Code Security Hook for Superego MCP Integration V2.
...
class SuperegoSecurityHook:
    ...
    def __init__(self, config_path: Optional[Path] = None, debug: bool = True):
        ...
        self.logger.info("Superego Security Hook v2 initialized")
    ...
    def setup_logging(self):
        ...
        logging.basicConfig(
            ...
            handlers=[
                logging.FileHandler('/tmp/superego_hook_v2.log'),
    ...
    def _initialize_interception_service(self, config_path: Optional[Path]) -> InterceptionService:
        ...
        try:
            ...
            if not config_path:
                ...
                config_path = hook_dir.parent / "config" / "rules.yaml"
    ...
    def _create_hook_response(self, hook_output, decision) -> Dict[str, Any]:
        ...
        response = {
            ...
            "timestamp": time.time(),
            "source": "superego_security_hook_v2"
        }
...
async def main():
    ...
    try:
        hook.logger.info("=== Superego Security Hook v2 Started ===")
