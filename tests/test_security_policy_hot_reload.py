...
class TestSecurityPolicyHotReload:
    ...
    @pytest.mark.unit
    def test_policy_engine_with_health_monitor(self, temp_rules_file, mock_health_monitor):
    ...
    @pytest.mark.unit
    async def test_reload_rules_success(self, policy_engine, temp_rules_file, mock_health_monitor):
    ...
    @pytest.mark.unit
    async def test_reload_rules_invalid_yaml(self, policy_engine, temp_rules_file, mock_health_monitor):
    ...
    @pytest.mark.unit
    async def test_reload_rules_invalid_rule_structure(self, policy_engine, temp_rules_file, mock_health_monitor):
    ...
    @pytest.mark.unit
    async def test_reload_rules_missing_file(self, policy_engine, temp_rules_file, mock_health_monitor):
    ...
    @pytest.mark.unit
    async def test_concurrent_reload_and_evaluation(self, policy_engine, temp_rules_file):
    ...
    async def test_full_hot_reload_scenario(self, policy_engine, temp_rules_file, mock_health_monitor):
