...
class RequestQueue:
    ...
    async def stop(self) -> None:
        ...
        try:
            ...
            all_tasks.extend(self._processor_tasks)
            ...
            logger.error("Error during queue shutdown", error=str(e))
        finally:
    ...
    async def enqueue(
        ...
        try:
            ...
            if self.enable_backpressure:
                ...
                await asyncio.wait_for(self.queue.put(queued_request), timeout=5.0)
